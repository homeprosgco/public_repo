...
import 'package:homeprosgapp/core/shared_ui/shared_ui.dart';
...
class CustomFormInput extends StatelessWidget {
  final String? label; // Optional label for the input field
  final FormInputType type; // Type of input field
  final String? value; // Initial value of the input
  ...
  const CustomFormInput({
    ...
    required this.keyName, required String hintText, required String labelText,
  });
  ...
  /// Builds the decoration for the input field, including hint text, padding, and borders.
  InputDecoration inputDecoration() {
    return InputDecoration(
      hintText: placeholder,
      errorText: errorText,
      hintStyle: TextStyle(color: Colors.grey.shade500).merge(hintStyle),
      ...
      contentPadding: inputPadding ?? const EdgeInsets.symmetric(horizontal: 12.0, vertical: 16.0),
    );
  }
}
