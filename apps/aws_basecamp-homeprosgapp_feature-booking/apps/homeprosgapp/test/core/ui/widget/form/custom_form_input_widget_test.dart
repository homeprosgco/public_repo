        ...
        MaterialApp(
          home: Scaffold(
            body: CustomFormInput(
              ...
              placeholder: 'Enter text', hintText: '',
            ),
          ),
        ),
      );
        ...
        MaterialApp(
          home: Scaffold(
            body: CustomFormInput(
              ...
              onChanged: (value) => selectedValue = value, hintText: '',
            ),
          ),
        ),
      );
        ...
        const MaterialApp(
          home: Scaffold(
            body: CustomFormInput(
              keyName: 'earlyAdopterEmail',
              type: FormInputType.text,
              errorText: 'Invalid input', hintText: '',
            ),
          ),
        ),
      );
        ...
        MaterialApp(
          home: Scaffold(
            body: CustomFormInput(
              ...
              onChanged: (value) => passwordValue = value, hintText: '',
            ),
          ),
        ),
      );
