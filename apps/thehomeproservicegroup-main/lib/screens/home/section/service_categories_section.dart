...
class ServiceCategoriesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PageSection(
      ...
      children: [
        ResponsiveRowColumnItem(child: Text('$professinalCategoriesCount')),
        ResponsiveRowColumnItem(
          child: buildSectionHeader(
            theme,
            spacing: k2,
            header: 'Book with confidence',
            body: 'Instantly book highly rated pros for cleaning and handyman tasks at an upfront price.',
          ),
        ),
        ResponsiveRowColumnItem(
          child: LayoutBuilder(
