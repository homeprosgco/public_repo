...
export declare class EstimateResolver {
    #private;
    ...
    address(estimate: Estimate, ctx: ServerContext): Promise<import("@graphql-schema/*").Address>;
    activities(estimate: Estimate, ctx: ServerContext): Promise<import("@graphql-schema/*").Activity[]>;
    comments(estimate: Estimate, ctx: ServerContext): Promise<import("@graphql-schema/*").Comment[]>;
    notes(estimate: Estimate, ctx: ServerContext): Promise<import("@graphql-schema/*").Note[]>;
}
