...
export declare class ProjectResolver {
    ...
    address(project: Project, ctx: ServerContext): Promise<import("@graphql-schema/*").Address>;
    activities(project: Project, ctx: ServerContext): Promise<import("@graphql-schema/*").Activity[]>;
    comments(project: Project, ctx: ServerContext): Promise<import("@graphql-schema/*").Comment[]>;
    notes(project: Project, ctx: ServerContext): Promise<import("@graphql-schema/*").Note[]>;
}
