...
const basicContact = () => {
  return {
    ...
    phone: faker.phone.phoneNumber('561-###-####'),
    address: address(),
  }
}
...
const companyProfile = () => {
  ...
  return {
    ...
    logoURL: imageURLs()[0],
    fax: faker.phone.phoneNumber('561-###-####'),
    socials: urls(),
...
export const expense = (userId?: string, createdById?: string) => {
  return {
    createdById,
    userId,
...
export const payment = (createdById?: string) => {
  return {
    amount: faker.commerce.price(),
    created: faker.date.recent().toISOString(),
    createdById,
